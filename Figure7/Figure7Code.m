...
figure('units','normalized')
[y,x]=find(B(:,1:10000));
Title='50 Percent HFR Injury + Plasticity';
h1=axes('position',[.13 .4 .77 .48]);
scatter(x(y<401)/5000,y(y<401),'marker','.','markeredgecolor',[.2 .2 .2])
set(gca,'Ytick',[])
ylim([0 400])
...
multcompare(stats);
% 5-10% sig, 15-20 NS, 25-40% sig, 45 not, 50+ sig 
...
plot([0 15],[5.25 5.25],'linewidth',1.5,'color',[1 31 91]/255)
text(15/2, 5.25*1.075,'NS','HorizontalAlignment','center','fontsize',20,'color',[1 31 91]/255)
plot([0 10],[6.25 6.25],'linewidth',1.5,'color',[153 0 0]/255)
text(10/2, 6.25*1.075,'*','HorizontalAlignment','center','fontsize',20,'color',[153 0 0]/255)
plot([25 40],[6.25 6.25],'linewidth',1.5,'color',[153 0 0]/255)
text(15/2+25, 6.25*1.075,'*','HorizontalAlignment','center','fontsize',20,'color',[153 0 0]/255)
plot([50 95],[6.25 6.25],'linewidth',1.5,'color',[153 0 0]/255)
text(45/2+50, 6.25*1.075,'*','HorizontalAlignment','center','fontsize',20,'color',[153 0 0]/255)
xlim([-2.5 100])
ylim([0 7])
...
l=legend({'Injury','Injury+Plasticity'},'Location','best')
set(l,'Position', [.5595 .67 .3732 .144])
legend('boxoff')
